...
import (
	...
	alert "kubeform.dev/provider-newrelic-api/client/informers/externalversions/alert"
	apiaccess "kubeform.dev/provider-newrelic-api/client/informers/externalversions/apiaccess"
	application "kubeform.dev/provider-newrelic-api/client/informers/externalversions/application"
	dashboard "kubeform.dev/provider-newrelic-api/client/informers/externalversions/dashboard"
	entity "kubeform.dev/provider-newrelic-api/client/informers/externalversions/entity"
	events "kubeform.dev/provider-newrelic-api/client/informers/externalversions/events"
	infra "kubeform.dev/provider-newrelic-api/client/informers/externalversions/infra"
	insights "kubeform.dev/provider-newrelic-api/client/informers/externalversions/insights"
...
func (f *sharedInformerFactory) Apiaccess() apiaccess.Interface {
	return apiaccess.New(f, f.namespace, f.tweakListOptions)
}
...
func (f *sharedInformerFactory) Insights() insights.Interface {
	return insights.New(f, f.namespace, f.tweakListOptions)
}

func (f *sharedInformerFactory) Nrql() nrql.Interface {
	return nrql.New(f, f.namespace, f.tweakListOptions)
}

func (f *sharedInformerFactory) One() one.Interface {
	return one.New(f, f.namespace, f.tweakListOptions)
}
