...
import (
	...
	v1alpha1 "kubeform.dev/provider-newrelic-api/client/listers/workload/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.WorkloadV1alpha1().Workloads(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.WorkloadV1alpha1().Workloads(namespace).Watch(context.TODO(), options)
			},
		},
