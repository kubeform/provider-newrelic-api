...
import (
	...
	v1alpha1 "kubeform.dev/provider-newrelic-api/client/listers/insights/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.InsightsV1alpha1().Events(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.InsightsV1alpha1().Events(namespace).Watch(context.TODO(), options)
			},
		},
		&insightsv1alpha1.Event{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *eventInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&insightsv1alpha1.Event{}, f.defaultInformer)
}
