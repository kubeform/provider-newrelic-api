...
import (
	...
	v1alpha1 "kubeform.dev/provider-newrelic-api/client/listers/application/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ApplicationV1alpha1().Settingses(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApplicationV1alpha1().Settingses(namespace).Watch(context.TODO(), options)
			},
		},
		&applicationv1alpha1.Settings{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *settingsInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&applicationv1alpha1.Settings{}, f.defaultInformer)
}
