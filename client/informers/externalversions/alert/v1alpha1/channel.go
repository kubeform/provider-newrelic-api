	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AlertV1alpha1().Channels(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AlertV1alpha1().Channels(namespace).Watch(context.TODO(), options)
			},
		},
		&alertv1alpha1.Channel{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *channelInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&alertv1alpha1.Channel{}, f.defaultInformer)
}
