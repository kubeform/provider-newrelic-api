	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SyntheticsV1alpha1().Monitors(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SyntheticsV1alpha1().Monitors(namespace).Watch(context.TODO(), options)
			},
		},
		&syntheticsv1alpha1.Monitor{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *monitorInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&syntheticsv1alpha1.Monitor{}, f.defaultInformer)
}
