	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.OneV1alpha1().Dashboards(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OneV1alpha1().Dashboards(namespace).Watch(context.TODO(), options)
			},
		},
		&onev1alpha1.Dashboard{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *dashboardInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&onev1alpha1.Dashboard{}, f.defaultInformer)
}
