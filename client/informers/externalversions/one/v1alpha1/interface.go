...
type Interface interface {
	...
	// DashboardRaws returns a DashboardRawInformer.
	DashboardRaws() DashboardRawInformer
}
...
// DashboardRaws returns a DashboardRawInformer.
func (v *version) DashboardRaws() DashboardRawInformer {
	return &dashboardRawInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
