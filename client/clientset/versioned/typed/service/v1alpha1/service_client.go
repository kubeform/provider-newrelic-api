...
// ServiceV1alpha1Client is used to interact with features provided by the service.newrelic.kubeform.com group.
type ServiceV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ServiceV1alpha1Client) Levels(namespace string) LevelInterface {
	return newLevels(c, namespace)
}
