...
// ApplicationV1alpha1Client is used to interact with features provided by the application.newrelic.kubeform.com group.
type ApplicationV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ApplicationV1alpha1Client) Settingses(namespace string) SettingsInterface {
