...
func newConditions(c *AlertV1alpha1Client, namespace string) *conditions {
	return &conditions{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *conditions) UpdateStatus(ctx context.Context, condition *v1alpha1.Condition, opts v1.UpdateOptions) (result *v1alpha1.Condition, err error) {
	result = &v1alpha1.Condition{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("conditions").
