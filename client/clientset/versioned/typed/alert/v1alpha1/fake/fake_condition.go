...
var conditionsResource = schema.GroupVersionResource{Group: "alert.newrelic.kubeform.com", Version: "v1alpha1", Resource: "conditions"}

var conditionsKind = schema.GroupVersionKind{Group: "alert.newrelic.kubeform.com", Version: "v1alpha1", Kind: "Condition"}
...
func (c *FakeConditions) UpdateStatus(ctx context.Context, condition *v1alpha1.Condition, opts v1.UpdateOptions) (*v1alpha1.Condition, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(conditionsResource, "status", c.ns, condition), &v1alpha1.Condition{})
