...
// PluginsV1alpha1Client is used to interact with features provided by the plugins.newrelic.kubeform.com group.
type PluginsV1alpha1Client struct {
	restClient rest.Interface
}

func (c *PluginsV1alpha1Client) AlertConditions(namespace string) AlertConditionInterface {
