...
type FakeKeys struct {
	Fake *FakeApiaccessV1alpha1
	ns   string
}

var keysResource = schema.GroupVersionResource{Group: "apiaccess.newrelic.kubeform.com", Version: "v1alpha1", Resource: "keys"}

var keysKind = schema.GroupVersionKind{Group: "apiaccess.newrelic.kubeform.com", Version: "v1alpha1", Kind: "Key"}
