...
type EventsV1alpha1Interface interface {
	...
	ToMetricsRulesGetter
}

// EventsV1alpha1Client is used to interact with features provided by the events.newrelic.kubeform.com group.
type EventsV1alpha1Client struct {
	restClient rest.Interface
}

func (c *EventsV1alpha1Client) ToMetricsRules(namespace string) ToMetricsRuleInterface {
	return newToMetricsRules(c, namespace)
}
